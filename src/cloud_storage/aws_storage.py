...
class SimpleStorageService:
    ...
    def __init__(self):
        """
        Initiliases the SimpleStorageService instance with S3 resource and client
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
        """
        Loads a serialised model from the specified S3 bucket.
        ...
        Returns:
        -------
        object: The deserialised model object.
        """
        try:
