...
class MongoDBClient:
    ...
    __init__(database_name: str) -> None
        Initialised the MongoDB connection using the given database name.
    """
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        """
        Initialised a connection to the MongoDB database. If no existing connection is found, it establishes a new one.
        ...
        ------
        MyException
            If there is an issue connection to MongoDB or if the environment variable for the MongoDB URL is not set.
        """
        try:
            # Check if a MongoDB client connection is already established; if not, create one
