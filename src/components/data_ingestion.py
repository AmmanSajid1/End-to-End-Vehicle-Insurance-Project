...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        Description: This method splits the datframe into training and testing sets based on split ratio
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Output: train set and test set are returned as artifacts of the data ingestion component
        On Failure: Write an exception log and then raise an exception
        """
