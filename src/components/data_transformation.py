...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            ss_features = self._schema_config['standard_scale_features']
            mm_columns = self._schema_config['min_max_scale_features']
            logging.info("Columns loaded from schema.")

            # Creating preprocessor pipeline
            preprocessor = ColumnTransformer(
                transformers=[
                    ("StandardScaler", numeric_transformer, ss_features),
